...
const Dashboard = () => {
  ...
  return (
    <div className="pb-12">
      {/* Stats Cards */}
      <div className="py-3 px-4 md:py-6 md:px-6">
      ...
      <div className="py-3 px-4 md:py-4 md:px-6">
        <div className="flex items-center justify-between mb-3 md:mb-4">
          <h2 className="text-base md:text-lg font-medium text-white">My Automations</h2>
          <div className="flex">
            <Link href="/automations" className="text-xs md:text-sm font-medium text-blue-400 hover:text-blue-300 flex items-center">
              ...
              <div key={i} className="bg-[#0f0f0f] border border-[#2a2a2a] shadow rounded-sm overflow-hidden">
                ...
                <div className="p-3 md:p-4">
                  <div className="flex items-center mb-3 md:mb-4">
                    <Skeleton className="h-8 w-8 md:h-10 md:w-10 rounded-sm" />
                    <Skeleton className="h-4 w-4 md:h-5 md:w-5 mx-2 md:mx-3" />
                    <Skeleton className="h-8 w-8 md:h-10 md:w-10 rounded-sm" />
                  </div>
      ...
      <div className="py-3 px-4 md:py-4 md:px-6">
        <h2 className="text-base md:text-lg font-medium text-gray-900 dark:text-white mb-3 md:mb-4">Popular Templates</h2>
        
        <div className="bg-white dark:bg-[#0f0f0f] border border-gray-200 dark:border-[#2a2a2a] shadow rounded-sm overflow-hidden">
          <div className="px-3 py-4 md:px-4 md:py-5 lg:p-6">
            <div className="grid grid-cols-1 gap-3 md:gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
              {loadingTemplates ? (
                // Loading skeleton
                Array(4).fill(0).map((_, i) => (
                  <div key={i} className="border border-gray-200 dark:border-[#2a2a2a] rounded-sm overflow-hidden bg-gray-50 dark:bg-[#181818]">
                    <div className="px-3 py-2 md:px-4 md:py-3 bg-gray-100 dark:bg-[#1f1f1f] border-b border-gray-200 dark:border-[#2a2a2a]">
                      <Skeleton className="h-4 md:h-5 w-3/4" />
                    </div>
                    <div className="p-3 md:p-4">
                      <div className="flex items-center mb-2 md:mb-3">
                        <Skeleton className="h-6 w-6 md:h-8 md:w-8 rounded-sm" />
                        <Skeleton className="h-4 w-4 md:h-5 md:w-5 mx-1 md:mx-2" />
                        <Skeleton className="h-6 w-6 md:h-8 md:w-8 rounded-sm" />
                      </div>
                      <Skeleton className="h-3 md:h-4 w-full mb-2 md:mb-3" />
                      <Skeleton className="h-6 md:h-8 w-full rounded-sm" />
                    </div>
                  </div>
                ))
              ) : (
            ...
            <div className="mt-4 md:mt-6 text-center">
              <Link href="/templates" className="inline-flex items-center text-xs md:text-sm font-medium text-blue-600 dark:text-blue-400 hover:text-blue-500 dark:hover:text-blue-300">
                View all templates
      ...
      <div className="py-3 px-4 md:py-4 md:px-6 pb-8 md:pb-12">
        <h2 className="text-base md:text-lg font-medium text-gray-900 dark:text-white mb-3 md:mb-4">Recent Activity</h2>
          ...
          <div className="px-3 py-4 md:px-4 md:py-5 lg:p-6">
            {loadingHistories ? (
              <div className="space-y-6 md:space-y-8">
                {Array(4).fill(0).map((_, i) => (
                  <div key={i} className="flex">
                    <Skeleton className="h-8 w-8 md:h-10 md:w-10 rounded-full mr-3 md:mr-4" />
              ...
              <>
                ...
                <div className="mt-4 md:mt-6 text-center">
                  <Link href="/history" className="inline-flex items-center text-xs md:text-sm font-medium text-blue-600 dark:text-blue-400 hover:text-blue-500 dark:hover:text-blue-300">
                    View all activity
                    <ArrowRight className="ml-1 h-3 w-3 md:h-4 md:w-4" />
                  </Link>
                </div>
