    ...
    <div className="h-screen w-full bg-gradient-to-b from-background to-background/80 flex items-center justify-center p-4">
      <div className="max-w-7xl w-full grid md:grid-cols-2 gap-6 items-center">
        ...
        <div className="flex flex-col order-2 md:order-1">
          <div className="w-full mx-auto text-left" style={{ maxWidth: "450px" }}>
            <Logo size="lg" />
          </div>
          <div className="mx-auto space-y-5 text-left" style={{ maxWidth: "450px" }}>
          ...
          <div className="flex flex-wrap gap-2 pt-4 justify-start" style={{ maxWidth: "450px", margin: "0 auto" }}>
                          ...
                          <FormItem>
                            ...
                            <div className="grid grid-cols-2 gap-4 pt-2">
                              ...
                              >
                                ...
                                <span className="text-xs text-white mt-1">For developers</span>
                              </Button>
                              <Button
                                type="button"
                              ...
                              >
                                ...
                                <span className="text-xs text-white mt-1">Customer interface</span>
                              </Button>
                            </div>
                            <FormMessage />
                          </FormItem>
